        ...
        {loading ? (
          ...
          <>
            ...
            <div className="space-y-2 mb-5">
              {data.byPage.map((p) => (
                <div key={p.pageId || "no_page"} className="bg-[#161310] border border-[#241f17] rounded-lg px-3 py-2.5">
...
// ---- GROUP SCREEN ---------------------------------------------------------
function GroupScreen({ groupId, entries, pages, fraudResults, refreshFraudResults, onBack, refreshEntries, moderator, authedFetch, isAdmin, allowedGroups }) {
