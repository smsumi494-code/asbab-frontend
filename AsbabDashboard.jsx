            ...
            <>
              ...
              <div>
                ...
                <div className="space-y-2 mb-3">
                  ...
                  <p className="text-[10px] text-[#6b6152] mt-2">
                    Steadfast Moderator অ্যাকাউন্ট (এই পেইজের) — কুরিয়ারে পাঠানোর পর Parcel ID-তে ক্লিক করলে রাইডারের নাম্বার/ট্র্যাকিং দেখাতে ব্যবহার হবে (ঐচ্ছিক)
                  </p>
                  <input
                    type="email"
...
// ---- HOME SCREEN --------------------------------------------------------
function HomeScreen({ entries, onOpenGroup, onOpenMenu, onOpenPurchaseCost, onOpenRecycleBin, recycleBinItems }) {
              ...
              {entry.uploading ? (
                ...
                <>
                  ...
                  {groupId === "website_order" ? (
                    ...
                    <button
                      onClick={() => isAdmin && entry.consignmentId && runTracking(entry)}
              ...
              <div>
                {trackingFor.data.status && (
                  <div className="rounded-xl border border-[#3a3226] bg-[#17140f] px-4 py-2 mb-3 text-center">
                    <span className="text-[13px] text-[#d9b877] font-medium">{trackingFor.data.status}</span>
                  </div>
                )}
