...
// ---- HOME SCREEN --------------------------------------------------------
function HomeScreen({ entries, allOrderEntries, groupCounts, onOpenGroup, onOpenMenu, onOpenPurchaseCost, onOpenRecycleBin, onOpenAnalytics, recycleBinItems, isAdmin, allowedGroups, moderator, authedFetch }) {
