...
import {
  ...
  Loader2, Paperclip, ChevronLeft, Menu, LogOut, UserPlus, Key, Shield, Lock, BarChart3, AlertTriangle, Siren,
} from "lucide-react";
      ...
      <div className="flex flex-col gap-2 px-4 pt-4">
        {rows.map((g, i) => (
          <button
            ...
            className="animate-tile-in w-full flex items-center gap-3 px-4 py-3.5 text-left rounded-2xl bg-[#161310] shadow-[0_4px_14px_rgba(0,0,0,0.4)] border-l-4 active:scale-[0.98] transition-transform duration-100"
            style={{ animationDelay: `${i * 40}ms`, borderLeftColor: g.color }}
          >
            <div
              className="w-12 h-12 rounded-full flex items-center justify-center text-sm font-semibold text-[#0f0d0a] shrink-0"
              style={{ backgroundColor: g.color }}
            >
              {g.id === "emergency" ? <Siren size={20} /> : g.initials}
            </div>
      ...
      <div className="flex flex-col gap-2 px-4 mt-4">
        {isAdmin && (
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-3.5 text-left rounded-2xl bg-[#161310] shadow-[0_4px_14px_rgba(0,0,0,0.4)] border-l-4 active:scale-[0.98] transition-transform duration-100"
            style={{ borderLeftColor: "#7a9db8" }}
          >
