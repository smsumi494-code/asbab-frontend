            ...
            <div className="px-4 pt-4 pb-4">
              <div className="flex items-center justify-between mb-3">
                <span className="text-[11px] text-[#6b6152]">
                  ...
                  {(groupId === "all_order" || groupId === "pending") && isAdmin && (
                    <button
                      onClick={() => sendToEmergency(entry)}
                      className="ml-2 px-1.5 py-0.5 rounded bg-[#3a1616] border border-[#5c2e2e] text-[#e0a3a3] text-[10px] font-medium"
                    >
                      Emergency
                    </button>
                  )}
