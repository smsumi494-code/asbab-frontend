  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div
            className="w-[66px] h-[66px] rounded-full flex items-center justify-center shrink-0 relative overflow-hidden"
            style={{ border: "1.5px solid #C9A24B", background: "#0a0806", boxShadow: "0 0 18px rgba(201,162,75,0.25)" }}
          >
            <span className="absolute -top-[11px] text-[13px] z-10" style={{ color: "#E8CD8A" }}>👑</span>
            {profilePictureUrl ? (
