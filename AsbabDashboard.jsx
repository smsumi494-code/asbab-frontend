...
<body>
  ...
  <script>
    ${
      ...
      // Classic "pencil sketch" technique: draw a grayscale base, then
      // draw an inverted + blurred copy on top blended with color-dodge
      // — this naturally produces soft pencil-like line art from a photo.
      var img = new Image();
      ...
      img.onload = function () {
        try {
          ...
          ctx.filter = 'grayscale(100%) invert(100%) blur(' + Math.max(3, Math.round(w / 120)) + 'px)';
