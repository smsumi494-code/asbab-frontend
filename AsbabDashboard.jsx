      ...
      <div className="divide-y divide-[#1c1913]">
        {rows.map((g, i) => (
          <button
            ...
            className="animate-tile-in w-full flex items-center gap-3 px-5 py-4 text-left active:bg-[#161310] active:scale-[0.99] transition-transform duration-100"
    ...
    <div className="min-h-screen bg-[#0f0d0a] text-[#f2ede4] flex flex-col" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <main className="flex-1 max-w-lg mx-auto w-full px-5 py-5 space-y-5">
        ...
        {displayList.map((entry) => {
          ...
          <article
            key={entry.id}
            className={`animate-card-in rounded-2xl overflow-hidden border ${entry.uploading ? "opacity-60" : ""} ${
