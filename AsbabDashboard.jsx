              ...
              <div>
                ...
                {(trackingFor.data.customerName || trackingFor.data.customerAddress || trackingFor.data.customerPhone) && (
                  <div className="rounded-xl border border-[#3a3226] bg-[#17140f] px-4 py-3 mb-3 space-y-1">
                    ...
                    {(trackingFor.data.codAmount || trackingFor.data.deliveryCharge) && (
                      <p className="text-[12px] text-[#8a7a5c] pt-1">
                        {trackingFor.data.codAmount && <>COD: ৳{trackingFor.data.codAmount}</>}
                        {trackingFor.data.codAmount && trackingFor.data.deliveryCharge && " · "}
                        {trackingFor.data.deliveryCharge && <>ডেলিভারি চার্জ: {trackingFor.data.deliveryCharge}</>}
                      </p>
                    )}
                  </div>
                )}
