...
// ---- HOME SCREEN --------------------------------------------------------
function HomeScreen({ entries, onOpenGroup, onOpenMenu, onOpenPurchaseCost, onOpenRecycleBin, onOpenAnalytics, recycleBinItems, isAdmin, allowedGroups, moderator, authedFetch }) {
...
function BottomNav({ active, onNavigate, onFraudCheck }) {
  const leftItems = [
