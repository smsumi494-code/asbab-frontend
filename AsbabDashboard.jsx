                ...
                {trackingFor.data.status && (
                  <div className="rounded-xl border border-[#3a3226] bg-[#17140f] px-4 py-2 mb-3 text-center">
                    ...
                    {trackingFor.data.codAmount && (
                      <span className="text-[13px] text-[#c9bfa8]"> · COD: ৳{trackingFor.data.codAmount}</span>
                    )}
                    {trackingFor.data.deliveryCharge && (
                      <span className="text-[11px] text-[#8a7a5c]"> (ডেলিভারি চার্জ: {trackingFor.data.deliveryCharge})</span>
                    )}
                  </div>
                )}
